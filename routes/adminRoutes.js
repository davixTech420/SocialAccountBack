...
router.get("/credentials",SocialAccountController.getSocialAccount);
router.post("/credentials",SocialAccountController.createSocialAccount);
router.put("/credentials/:id",SocialAccountController.updateSocialAccount);
router.delete("/credentials/:id",SocialAccountController.deleteSocialAccount);
